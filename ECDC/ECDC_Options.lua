...
function ECDC_CreateOptionsMenu()
	...
	if InterfaceOptions_AddCategory then
		...
		local category, layout = _G.Settings.RegisterCanvasLayoutCategory(addon.panel, addon.panel.name, addon.panel.name)
	...
	for class,spells in pairsByKeys(classPanels) do
		...
		if InterfaceOptions_AddCategory then
			...
			local category, layout = _G.Settings.RegisterCanvasLayoutCategory(addon.subpanel, addon.subpanel.name)
			_G.Settings.RegisterAddOnCategory(category)
		end
